...
#### **_Converting Between Column Letters and Numbers_**
...
#### **_Getting Rows and Columns from the Sheets_**
...
1. Counts the total population of each county
1. Prints the results
This means your code will need to do the following:

1. Open and read the cells of an Excel document with the openpyxl module.
1. Calculate all the tract and population data and store it in a data structure.
1. Write the data structure to a text file with the .py extension using the pprint module.
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000062.jpg)
...
1. If the row is for garlic, celery, or lemons, changes the price

This means your code will need to do the following:

1. Open the spreadsheet file.
1. For each row, check whether the value in column A is Celery, Garlic, or Lemon.
1. If it is, update the price in column B.
1. Save the spreadsheet to a new file (so that you don’t lose the old spreadsheet, just in case).
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000007.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000100.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000046.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000140.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000083.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000099.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000122.jpg)
...
Create a program multiplicationTable.py that takes a number N from the  command line and creates an N×N multiplication table in an Excel 1. 1. spreadsheet. For example, when the program is run like this:
```py
py multiplicationTable.py 6
```
. . . it should create a spreadsheet that looks like Figure 13-11.

![enter image description here](https://automatetheboringstuff.com/2e/images/000067.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000013.jpg)
...
![enter image description here](https://automatetheboringstuff.com/2e/images/000108.jpg)
